/**
   ...
   & measuring battery level. For detail description, please visit: https://github.com/FabienFerrero/RF210_SB

   @version 1.2.2
   @date 2024-05-23

   @board Select "Widuo RAK3172 Evaluation board" on https://github.com/RAKWireless/RAKwireless-Arduino-BSP-Index
...
{ 
  ...
  api.system.atMode.add("SEND", "Send LoRaWan packet with sensor", "SEND", send, RAK_ATCMD_PERM_READ);
...
currentMillis = millis();       
  ...
  ////Serial.println("Sound treatment");
  currentMillis = millis(); 
